  ...
  %! abjad.LilyPondFile._get_format_pieces()
{
    ...
    <<
        \context TimeSignatureContext = "Global Context"
        {
            ...
            \time 1/8
            s1 * 1/8
            - \markup \override #'(font-name . "Bodoni72 Book Italic") \fontsize #6 { " 1\'39\" - 1\'44\" "  }
            ...
            \time 1/8
            s1 * 1/8
            - \markup \override #'(font-name . "Bodoni72 Book Italic") \fontsize #6 { " 1\'54\" - 1\'57\" "  }
            \set Score.proportionalNotationDuration = #(ly:make-moment 1 60)
            \time 1/8
            s1 * 1/8
                        ...
                        \context Voice = "viola voice"
                        {
                            ...
                            <<
                                \context Voice = "viola voice temp"
                                {
                                    ...
                                    - \tweak bound-details.right.text \markup \with-color "mediumblue" { -5° }
                                    \startTextSpan
                                    ...
                                    \tweak TupletNumber.text #(tuplet-number::append-note-wrapper(tuplet-number::non-default-tuplet-fraction-text 11 9) (ly:make-duration 5 0))
                                    \times 9/11
                                    {
                                        \once \override Dots.staff-position = #2
                                        <c g>8.
                                        ...
                                        - \tweak bound-details.right.text \markup \with-color "darkmagenta" { \fontsize #3.5 \override #'(font-name . "ekmelos") \char ##xe222 }
                                        \startTextSpanOne
                                        - \tweak color #darkred
                                        - \tweak padding #10
                                        - \abjad-solid-line-with-arrow
                            ...
                            - \tweak padding #6.5
                            - \abjad-dashed-line-with-hook
                            - \tweak bound-details.left.text \markup \concat { \with-color "rosybrown" { "IV" } \hspace #0.5 }
                            \startTextSpanTwo
                            - \tweak stencil #constante-hairpin
                            \<
                            ~
                        ...
                        \tag #'voice4
                        {
                            \context UnmeteredStaff = "bassflute staff"
                            {
                                \context Voice = "bassflute voice"
                                {
                                    ...
                                    \tweak Accidental.text \markup \concat { \one-nineteen-limit-schisma-up \hspace #0.125 \sharp-one-syntonic-comma-down  }
                                    gs'!16
                                    ...
                                    \tweak Accidental.stencil #ly:text-interface::print
                                    \tweak Accidental.text \markup \concat { \one-nineteen-limit-schisma-up \hspace #0.125 \natural-one-syntonic-comma-down  }
                                    d'!16
                                    \ff
                                    ^ \markup \center-align { \concat { -16 } }
                                      %! abjad.glissando(7)
                        ...
                        \tag #'voice6
                        {
                            \context UnmeteredStaff = "bassclarinet staff"
                            {
                                \context Voice = "bassclarinet voice"
                                {
                                    ...
                                    \stopStaff \startStaff
                                    \tweak Accidental.stencil #ly:text-interface::print
                                    \tweak Accidental.text \markup \concat { \one-nineteen-limit-schisma-up \hspace #0.125 \flat-one-syntonic-comma-down  }
                                    bf!8
                                    ^ \markup \center-align { \concat { -16 } }
                                      %! abjad.glissando(7)
                                    - \abjad-zero-padding-glissando
                        ...
                        \tag #'voice8
                        {
                            \context UnmeteredStaff = "cello 1 staff"
                            {
                                \context Voice = "cello 1 voice"
                                {
                                    ...
                                    - \espressivo
                                    \mf
                                    ^ \markup \center-align { \center-column { "-40" } }
                                      %! abjad.glissando(7)
                                    - \abjad-zero-padding-glissando
                                      %! abjad.glissando(7)
                                    \glissando
