...
score = library.bibliopegy_score([(1, 8) for _ in range(1, 24)])
...
trinton.make_music(
    lambda _: trinton.select_target(_, (13, 20)),
    evans.RhythmHandler(
...
trinton.make_music(
    lambda _: trinton.select_target(_, (7, 20)),
    evans.RhythmHandler(
        evans.talea(
            [
                6,
...
library.forbid_break(score=score, measures=[4, 5, 6, 7, 8, 9, 10, 11])

library.write_timestamps(
    global_context=score["Global Context"],
    second_range=(117, 1000),
    measure_range=(1, 20),
)
