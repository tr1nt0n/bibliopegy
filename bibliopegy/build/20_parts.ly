    ...
    <<
        \context TimeSignatureContext = "Global Context"
        {
            ...
            \time 1/8
            s1 * 1/8
            - \markup \override #'(font-name . "Bodoni72 Book Italic") \fontsize #6 { " 6\'46\" - 6\'52\" "  }
            - \tweak padding #3
                        ...
                        \context Voice = "viola voice"
                        {
                            <<
                                ...
                                %%% \once \override Staff.BarLine.hair-thickness = 1 
                                    ...
                                    \pp
                                    - \tweak padding #7
                                    - \markup \override #'(font-name . "Source Han Serif SC") { \hspace #-22 \center-column { \line { ベッドでは靴下を履いたまま、} \line { 木の影が芝生のプールに黒く横たわるのを見る。 } } }
                                    - \tweak whiteout ##f
                                    ^ \markup \with-color "indianred" { tast. poss. sempre }
                                    ...
                                    ^ \markup {
                                      ...
                                      \concat {
                                          \abjad-metronome-mark-markup #3 #0 #1 #"30"
                                      }
                                    }
                                    r32
                                    e'16
