...
\textbf{\circled{3} When the first percussionist is playing the anvils}, a sustained note is accomplished by \textbf{scraping}, and a short one by \textbf{slashing}.
